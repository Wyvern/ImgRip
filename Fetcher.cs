namespace ImgRipper
{
    ...
    class Fetcher
    {
        ...
        public void GetFile(string url, string file)
        {
            using (wc = new WebClient())
            {
                ...
                { if ((e.Cancelled || e.Error != null) && File.Exists(file)) File.Delete(file); mre.Set(); };
        ...
        public void Reset()
        {
            ...
            Imgs.Clear();
            Canceled = Dropped = SkipPage = false;
            Current = null;
    ...
    enum ParseStyle
    {
        NotSupport, Heels, Duide, Tu11, MeiTuiJi, PalAthCx, DeskCity, Pics100,
        WallCoo, Mtswa, Ttmnw, Xyuba, Yzmnw, GirlCity, Tu25,Voc,Net6188,
        China016, PP169, RT1000, MeiTu77, KK158, MM920,MeiTuShow, Net6s8
    };
